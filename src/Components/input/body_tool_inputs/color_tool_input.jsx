...
export class ColorToolInput extends Component {
  state = {
    h: 0,
    s: 0,
  };
  ...
  postToServer = (e) => {
    ...
    dataform.append("X",this.props.lastMouseClick[0])
    dataform.append("Y", this.props.lastMouseClick[1]);
    axios
      .post(Server + EndPoints.ColorToolEndPoint, dataform, {
